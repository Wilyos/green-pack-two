        ...
        >
          <div className="flex items-center justify-between gap-4">
            <div className="min-w-0">
              <p className="text-[11px] uppercase tracking-[0.24em] text-primary/80">Haz el cambio</p>
              <p className="mt-1 text-xs sm:text-sm font-semibold leading-tight pr-2">Pasa de icopor a empaque de papel reciclable para tu producto estrella</p>
            </div>
